...
const activitiesData = [
  {
    ...
    imageUrl: "/improved-images/balgonie(13).jpeg", // Replace with actual image path
  },
  {
    name: "Sauna",
    description: "Relax in a cozy sauna after a long day.",
    imageUrl: "/improved-images/sauna.jpeg", // Replace with actual image path
  },
  {
    name: "Snug Lounge",
    description: "A cozy place to relax with a Smart TV, board games, piano and guitars",
    imageUrl: "/improved-images/balgonie(8).jpeg", // Replace with actual image path
  },
  {
    name: "Garden",
    description: "Large mature garden with patio seating area, and covered decked area with seating and charcoal BBQ",
    imageUrl: "/images/processed (7).jpeg", // Replace with actual image path
  },
  {
    name: "5 Bedrooms",
    description: "2 Super king size bedrooms, 2 twins and 1 single",
    imageUrl: "/improved-images/balgonie(9).jpeg", // Replace with actual image path
  },
  {
    name: "2 Wood Burners",
    description: "2 big baskets of logs provided",
    imageUrl: "/improved-images/balgonie(3).jpeg", // Replace with actual image path
  },
