...
Outdoors, the large garden is caringly tended and short walks to the nearby river are ideal for clearing the mind and enjoying the local wildlife.
      ...
      >
        <div className='section-left-3'>
          <img className='section-img-1' src={process.env.PUBLIC_URL + "/improved-images/pentlands(1).jpeg"} alt="Image" />
        </div>
      ...
      >
        ...
        <div className='section-right-4'>
          <img className='section-img-1' src={process.env.PUBLIC_URL + "/improved-images/horseriding.jpeg"} alt="Image" />
        </div>
        </motion.div>
        ...
        variants={sectionVariants}
      >
        <div className='section-left-5'>
          <img className='section-img-1' src={process.env.PUBLIC_URL + "/improved-images/edinburgh.jpeg"} alt="Image" />
        </div>
        <div className='section-right-5'>
